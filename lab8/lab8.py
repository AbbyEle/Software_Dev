...
print("Good morning! This is my first Python code!")
print("\tGood morning! \nThis is my first Python code!")
print("\tGood morning! \nThis is my first \"Python\" code!");

print('\n------Example 2: data type -------')
print(f"Data type of 3.6 = {type (3.56)}")
...
print (f"score 1 = {score1}, score 2 = {score2} score3 = {score3}")
...
print(f"The modulus(remainder) {num1} and {num2} is            {num1%num2}")
...
hyp = (x**2 + y**2)**0.5
#prompt result
print(f"The hypotenuse of {x} and {y} is {hyp:0}")
print(f"The hypotenuse of {x} and {y} is {hyp:0.6f}")
...
compare3 = n1>n2
compare4 = n2<=n3
print(f"is n1 greater n2?                 {compare3}")
...
print(f"Slice from the 3rd to 8th                                  {username[2:7]}")
...
#concatenate the second color with the 3rd number
#new_word = colors[1] + number[2]  #--> data type error
#print(f"The new word is                     {new_word}")

print('\n------Example 21: remove items from a list -------')
# remove the second last color
colors.pop(-2)
