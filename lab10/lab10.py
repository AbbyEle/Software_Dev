...
# prompt result
print(f"There is/are {negativecounter} negative numbers/s")
...
# get user input
enteredcolor = input("Enter a color: ")

# remove whitespace and convert to lowercase
enteredcolor = enteredcolor.strip().lower()
...
for eachcolor in colors:
    if eachcolor == enteredcolor:
        evencount += 1
        break

# conditional statement
if evencount > 0:
    print(f"{enteredcolor} color is in the list")
else:
    print(f"{enteredcolor} color IS NOT in the list")
